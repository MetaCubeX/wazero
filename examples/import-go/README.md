...
export functions using [HostModuleBuilder](https://pkg.go.dev/github.com/metacubex/wazero#HostModuleBuilder) and how a
...
[wasi package](https://pkg.go.dev/github.com/metacubex/wazero/wasi).
